...
import yanrui.thread.Consumer;
import yanrui.thread.Producer;
...
public class ThreadTest {
    public static void main(String[] args){
        ...
        ThreadPoolExecutor productPool =
                new ThreadPoolExecutor(10,20,60, TimeUnit.MILLISECONDS,new ArrayBlockingQueue<Runnable>(5),new ThreadPoolExecutor.CallerRunsPolicy());
